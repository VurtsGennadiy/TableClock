...
#include <OneWire.h> // стандартная библиотека для работы с датчиком температуры по протоколу OneWire
#include "TM1637.h" // моя библиотека для дисплейного модуля
#include "DateTime.h" // моя библиотека для работы с типом данных DateTime
#include "pitches.h"  // ноты
#include "themes.h" // мелодии
